...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "dataengineering-youtube-cleansed-database", table_name = "raw_statistics_reference_data", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
